...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'Polygon Labeler_dialog_base.ui'))


class PolygonLabelerDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(PolygonLabelerDialog, self).__init__(parent)
